...
namespace YouTrackSharp.Management
{
    public interface ITimeTrackingManagementService
    {
        ...
        /// </summary>
        /// <remarks>Uses the REST API <a href="https://www.jetbrains.com/help/youtrack/devportal/operations-api-admin-timeTrackingSettings-workTimeSettings.html#get-WorkTimeSettings-method">Get System-wide Time Tracking Settings</a>.</remarks>
        ...
        /// </summary>
        /// <remarks>Uses the REST API <a href="https://www.jetbrains.com/help/youtrack/devportal/operations-api-admin-timeTrackingSettings-workTimeSettings.html#update-WorkTimeSettings-method">Set system-wide time tracking settings: a list of working days in a week, and a number of hours in a working day</a>.</remarks>
        ...
        /// </summary>
        /// <remarks>Uses the REST API <a href="https://www.jetbrains.com/help/youtrack/devportal/operations-api-admin-projects-projectID-timeTrackingSettings.html#get-ProjectTimeTrackingSettings-method">Get Time Tracking Settings for a Project</a>.</remarks>
        ...
        /// </summary>
        /// <remarks>Uses the REST API <a href="https://www.jetbrains.com/help/youtrack/devportal/operations-api-admin-projects-projectID-timeTrackingSettings.html#update-ProjectTimeTrackingSettings-method">Configure time tracking settings for a specific project</a>.</remarks>
